...
──────────────────────────────────────────────────────────────
        ...
        ═════════════ TRUST BOUNDARY ═════════════
         ...
         role = csi · org = <tenant-org> | Root · quota
                              ...
                              ▼
──────────────────────────────────────────────────────────────
 TENANT — own baremetal host + single-node Kubernetes
   WEKA CSI plugin (controller + node DaemonSet)
   Secret <csi-user>  +  StorageClass (dir/v1)
   PVC → PV → Pod · WEKA client (wekafs driver on host)
──────────────────────────────────────────────────────────────
```
